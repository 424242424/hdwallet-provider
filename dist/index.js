...
const getOptions_1 = require("./_constructor/getOptions");
const getPrivateKeys_1 = require("./_constructor/getPrivateKeys");
const getMnemonic_1 = require("./_constructor/getMnemonic");
...
class HDWalletProvider {
    constructor(...args) {
        ...
        this.engine.addProvider(new hooked_wallet_1.default({
            ...
            signTypedMessage({ data, from }, cb) {
                ...
                const sig = (0, eth_sig_util_1.signTypedData)(pkey, { data });
                cb(null, sig);
            }
        }));
        !shareNonce
    ...
    checkBIP39Mnemonic({ addressIndex, numberOfAddresses, phrase, password }) {
        ...
        this.hdwallet = ethereumjs_wallet_2.hdkey.fromMasterSeed(Buffer.from((0, bip39_1.mnemonicToSeedSync)(phrase, password)));
